    ...
    var $window = $(window);
        ...
        $window.on('scroll', function() {
            ...
            if (scroll <= 50) {
                ...
                logochange.attr('src', 'img/logo/logo-inner.png');
                logodefault.attr('src', 'img/logo/logo_paydollar_h120px.png');
            } 
            else {
                $("header").removeClass("fixedHeader").addClass("scrollHeader");
                logochange.attr('src', 'img/logo/logo_paydollar_h120px.png');
                logodefault.attr('src', 'img/logo/logo_paydollar_h120px.png');
            }
        });
