...
(function ($) {
    ...
    $.fn.menumaker = function (options) {
        ...
        return this.each(function () {
           ...
           $(this).find(/*" .navbar-toggler "*/ ).on('click', function () {
            ...
            nav.find('.navbar-nav_ver li ul').parent().addClass('has-sub_ver');
            nav.find('.navbar-nav li_ver ul li').parent().addClass('sub-menu_ver');

            var multiTg = function () {

                       // For First Level of VERTICAL
                nav.find(".has-sub_ver").prepend('<span class="submenu-button_ver"></span>');
                nav.find('.navbar-nav_ver > li.has-sub > .submenu-button_ver').on('click', function () {
                    $(this).next('.sub-menu_ver').slideToggle();
                    $(this).siblings('ul').addClass('open').slideToggle();
                    $(this).parents('.navbar-nav_ver > li.has-sub_ver').toggleClass('active').siblings('.has-sub_ver').children('.sub-menu_ver').slideUp().removeClass('open').parents('li').removeClass('active');
                });
    ...
    $(document).ready(function () {
        ...
        $('.navbar-nav_ver li').find('a[href="' + menuselctor + '"]').closest('li').addClass('active').parents().eq(1).addClass('current');
       $('.navbar-nav_ver li.has-sub_ver ul li').find('a[href="' + menuselctor + '"]').parents().eq(4).addClass('current');
